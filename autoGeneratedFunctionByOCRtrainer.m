...
% Auto-generated by ocrTrainer app on 18-Feb-2019
%-------------------------------------------------------
%
...
% ---------------------------------------------------
%  I = imread('/home/exs/editing_vid/tempFolder/allFrames/0000002.png');
%  figure
%  imshow(I)
%
...
if isempty(deblank(text))
  ...
  J = insertText(I, [N/2 M/2], text, ...
    'AnchorPoint', 'Center', 'FontSize', 24, 'Font', 'DejaVuSans');
